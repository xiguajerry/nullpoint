...
public class AStarCustomPathFinder
   ...
   private static boolean isBlockSolid(BlockPos block) {
      return AStarCustomPathFinder.mc.world.getBlockState(block).shapeCache != null && AStarCustomPathFinder.mc.world.getBlockState(block).shapeCache.isFullCube || AStarCustomPathFinder.mc.world.getBlockState(block).getBlock() instanceof SlabBlock || AStarCustomPathFinder.mc.world.getBlockState(block).getBlock() instanceof StairsBlock || AStarCustomPathFinder.mc.world.getBlockState(block).getBlock() instanceof CactusBlock || AStarCustomPathFinder.mc.world.getBlockState(block).getBlock() instanceof ChestBlock || AStarCustomPathFinder.mc.world.getBlockState(block).getBlock() instanceof EnderChestBlock || AStarCustomPathFinder.mc.world.getBlockState(block).getBlock() instanceof SkullBlock || AStarCustomPathFinder.mc.world.getBlockState(block).getBlock() instanceof PaneBlock || AStarCustomPathFinder.mc.world.getBlockState(block).getBlock() instanceof FenceBlock || AStarCustomPathFinder.mc.world.getBlockState(block).getBlock() instanceof WallBlock || AStarCustomPathFinder.mc.world.getBlockState(block).getBlock() instanceof StainedGlassBlock || AStarCustomPathFinder.mc.world.getBlockState(block).getBlock() instanceof PistonBlock || AStarCustomPathFinder.mc.world.getBlockState(block).getBlock() instanceof PistonExtensionBlock || AStarCustomPathFinder.mc.world.getBlockState(block).getBlock() instanceof PistonHeadBlock || AStarCustomPathFinder.mc.world.getBlockState(block).getBlock() instanceof StainedGlassBlock || AStarCustomPathFinder.mc.world.getBlockState(block).getBlock() instanceof TrapdoorBlock;
   }
